// ============================================================
// פיקוח פרויקטים — מחולל הכתבה השבועית.
// קורא ל-Claude עם construction_supervision/prompt.md, מקבל MDX, וכותב קובץ
// מודול תחת src/content/supervision/<date>-<slug>.js — המבנה ש-useSupervision()
// (src/lib/supervision.js) טוען אוטומטית.
//
// הרצה: ANTHROPIC_API_KEY=... node construction_supervision/scripts/generate-article.mjs
// ============================================================
...
const contentDir = join(root, 'src', 'content', 'supervision')
...
const obj = {
  ...
  title: fm.title || '',
  date,
  author: fm.author || 'המערכת, פיקוח פרויקטים',
  authorTitle: fm.authorTitle || 'פיקוח וניהול פרויקטים · קבוצת קורקוס',
  category: fm.category || 'פיקוח ביצוע',
  tags,
...
const file = `// נוצר אוטומטית — פיקוח פרויקטים · ${date}\nexport default ${JSON.stringify(obj, null, 2)}\n`
