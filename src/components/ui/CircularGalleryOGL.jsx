/* ============================================================
   גלריית ביצוע — קרוסלה מעוקלת מבוססת WebGL (OGL), למובייל בלבד.
   עובדת בגלילה/החלקה אופקית; התמונות מתעקלות בקשת ומגיבות למהירות.
   הותאמה מ-TSX (shadcn/Tailwind) ל-JSX + CSS רגיל בפרויקט.
   ============================================================ */
...
class App {
  ...
  createMedias(items, bend, textColor, borderRadius, font) {
    ...
    this.mediasImages = [...galleryItems, ...galleryItems] // שכפול ללולאה רציפה
...
/* ---------- רכיב React ---------- */
export default function CircularGalleryOGL({
  items,
  bend = 3,
  borderRadius = 0.05,
  scrollSpeed = 2,
  ...
  useEffect(() => {
    ...
    const computedColor = computedStyle.color || '#0b2a3a'
  ...
  return <div ref={containerRef} className={`cgal-ogl ${className}`.trim()} />
}
