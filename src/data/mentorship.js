...
export const mentorshipMeta = {
  ...
  lead: {
    he: 'יותר מ-30 שנות ניסיון בשטח, כמה כובעים מקצועיים בתוך אותה מסגרת — ייזום, ביצוע, פיקוח, תיווך — ורשת קשרים אמיתית בתעשייה. זה הבסיס לתוכנית ליווי שמלווה יזמים צעירים מהעסקה הראשונה ועד לעצמאות מלאה.',
...
export const stages = [
  ...
  },
  {
    ...
    tools: [
      ...
      { he: 'ניתוח רגישות — מה קורה כש-X משתנה', en: 'Sensitivity analysis — what happens when X changes' },
  ...
  },
  {
    ...
    color: '#16688c',
    desc: {
      he: 'הפיקוח הוא עיניים בשטח כשהכסף שלכם עובד. נלמד לבחור מפקח, מה לדרוש ממנו, כיצד לקרוא דו"חות פיקוח, ואיך להיות המנכ"ל — לא הצלחפת — של הפרויקט שלכם.',
  ...
  },
  {
    ...
    color: '#8c6d1f',
    desc: {
      he: 'שיווק טוב מתחיל עוד לפני שיש פיתרון. נלמד לתזמן שיווק לשוק, לבחור ערוצים, לעבוד עם מתווכים, לתמחר נכון, ולסגור עסקאות שמעשירות — לא רק "מוכרות".',
...
export const faqs = [
  ...
  },
  {
    ...
    a: { he: 'תלוי בקצב שלכם ובמחויבות. יזמים שעובדים בעצימות גבוהה מוצאים את עצמם מוכנים לעסקה עצמאית תוך 12–18 חודשים. אנחנו מתאימים את הקצב לחיים האמיתיים שלכם.', en: 'Depends on your pace and commitment. Entrepreneurs who work with high intensity find themselves ready for an independent deal within 12–18 months. We adapt the pace to your real life.' },
  },
  {
