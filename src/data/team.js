...
export const team = [
  ...
  },
  {
    ...
    imgPos: 'center 9%',    /* מקזז את דחיפת הזום כלפי מטה — הראש נשאר בגובה יעקב ומוטי */
    imgZoom: 1.3,    /* זום חזק יותר — הכתפיים מקצה לקצה; transform-origin עליון שומר על גובה הראש */
    imgBright: 1.2,  /* +20% בהירות — אפקט תאורת פורטרייט */
    bio: {
