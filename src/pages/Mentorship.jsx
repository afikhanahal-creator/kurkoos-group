...
const guideArticles = [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      'בניית הצעת מחיר נכונה: לא מה שהמוכר ביקש פחות כמה אחוזים, אלא מה שמצדיק ניתוח העסקה שלכם. אם הדוח 0 אומר שהעסקה עובדת ב3.2 מיליון, אז 3.5 מיליון שהמוכר ביקש אינו רק קצת יקר, הוא פשוט לא עובד. הצגה של ניתוח מובנה בפני המוכר הופכת שיחה ממקח וממכר לדיון עסקי.',
  ...
  },
  {
    ...
    paragraphs: [
      ...
      'LTV הוא המדד הראשון שהבנק בודק: כמה אשראי מתוך שווי הנכס. בפרויקטי ייזום, יזמים מתחילים יכולים לצפות ל60 עד 70 אחוז לכל היותר. כדי לפצות, צריך לבנות מבנה מימון שכולל הון עצמי, שותפויות אסטרטגיות, קרנות מימון חלופיות, ומימון ביניים.',
