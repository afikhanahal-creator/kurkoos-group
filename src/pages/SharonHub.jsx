...
/* ============================================================
   נדל"ן בהוד השרון והשרון, עמוד מוקד מקומי (Local Hub).
  ...
  const jsonLd = [
    ...
    },
    {
      ...
      itemListElement: [
        ...
        { '@type': 'ListItem', position: 2, name: 'נדל"ן בהוד השרון והשרון', item: 'https://www.kurkoos-group.co.il/real-estate-sharon' },
      ],
    },
  ]
  ...
  return (
    <>
      ...
      <PageHeader
        ...
        seoTitle='נדל"ן בהוד השרון והשרון: יזמות, ביצוע, פיקוח ותיווך'
        seoDescription='מחפשים חברת נדל"ן באזור השרון? קורקוס גרופ, שמשרדה בהוד השרון, מלווה פרויקטים ועסקאות בשרון והמרכז: יזמות נדל"ן, ביצוע ובנייה, ניהול ופיקוח פרויקטים, תיווך ושיווק נכסים.'
      />
