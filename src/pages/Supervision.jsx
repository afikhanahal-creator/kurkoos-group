...
import { whenIdle, importSupervisionArticle } from '../lib/prefetch.js'
...
export default function Supervision() {
  ...
  useEffect(() => whenIdle(importSupervisionArticle), [])
  ...
  const Card = ({ a }) => (
    <Reveal as="article" className="yz-card">
      <Link to={`/construction-supervision/${a.slug}`} className="yz-card__link" onMouseEnter={importSupervisionArticle} onFocus={importSupervisionArticle}>
