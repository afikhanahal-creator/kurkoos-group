...
export default function Supervision() {
  ...
  return (
    <>
      <PageHeader
        eyebrow="פיקוח פרויקטים"
        title="המדריך לפיקוח בנייה"
        lead="פרשנות מקצועית ועניינית מהשטח: בקרת איכות, פיקוח ביצוע, ליקויים ובדק, ניהול תקציב וסיכונים. כל מה שחשוב לדעת כשמפקחים על פרויקט בנייה."
