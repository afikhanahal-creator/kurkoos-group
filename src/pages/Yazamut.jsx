  ...
  return (
    <>
      <PageHeader
        ...
        lead="פרשנות שבועית, עניינית ועדכנית על יזמות נדל״ן בישראל: התחדשות עירונית, מימון, רגולציה, קרקע ומגמות שוק."
        crumbs={[{ label: 'יזמות נדל״ן', to: '/divisions/development' }, { label: 'הטור' }]}
        /* הכותרת על המסך משתמשת בגרשיים, ושאר האתר והעמוד הסטטי בגרש כפול.
           כאן מיישרים את כותרת ה-SEO לצורה אחת, בלי לגעת בכותרת הנראית. */
        seoTitle='המדריך ליזמות נדל"ן'
      />
