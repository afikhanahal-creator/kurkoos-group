...
import { mergeArticles, loadSeed as loadYazamutSeed } from '../../lib/yazamut.js'
import { mergeConstructions, loadSeed as loadConstructionsSeed } from '../../lib/constructions.js'
import { mergeSupervision, loadSeed as loadSupervisionSeed } from '../../lib/supervision.js'
import { mergeBrokerage, loadSeed as loadBrokerageSeed } from '../../lib/brokerage.js'
...
const COLUMNS = [
  {
    ...
    key: 'yazamut_articles', merge: mergeArticles, load: loadYazamutSeed, route: '/yazamut-nadlan', folder: 'yazamut',
  ...
  },
  {
    ...
    key: 'constructions_articles', merge: mergeConstructions, load: loadConstructionsSeed, route: '/constructions', folder: 'constructions',
  ...
  },
  {
    ...
    key: 'supervision_articles', merge: mergeSupervision, load: loadSupervisionSeed, route: '/construction-supervision', folder: 'supervision',
  ...
  },
  {
    ...
    key: 'brokerage_articles', merge: mergeBrokerage, load: loadBrokerageSeed, route: '/real-estate-guide', folder: 'brokerage',
