...
export const projectSchema = [
  ...
  {
    section: 'פריסת התמונה הראשית',
    fields: [
      {
        key: 'about_portrait',
        label: 'תמונה ראשית לאורך (Portrait)',
        type: 'bool',
        hint: 'דלוק = התמונה מוצגת ביחס לאורך (צרה יותר) וממלאת את כל גובה הטקסט בצד. כבוי = לרוחב (ברירת מחדל). התמונה תמיד מכסה את הכרטיס עם פינות עגולות.',
      },
      {
        key: 'about_spaced',
        label: 'תצוגת התמונה: מילוי מלא ↔ עם מרווח',
        type: 'bool',
        hint: 'כבוי = מילוי מלא — התמונה נפרסת עד הקצה ותופסת את הפינות העגולות של הכרטיס. דלוק = עם מרווח — התמונה עומדת בנפרד עם אוויר מסביב ופינות עגולות מכל הצדדים. (לחצו "צפייה בדף" למעלה כדי לראות את התצוגה.)',
      },
    ],
  },
  {
    section: 'כיוון התמונה בעמוד "כל הפרויקטים"',
    fields: [
      {
        key: 'card_layout',
        label: 'כיוון/יחס התמונה בעמוד "כל הפרויקטים"',
        type: 'select',
        options: PROJECT_CARD_LAYOUT,
        hint: 'איך תוצג תמונת הפרויקט בעמוד "כל הפרויקטים": "לרוחב" לתמונות Landscape (רחב, בלי חיתוך הצדדים), "לאורך" ל-Portrait, "מרובע" לרגיל. אם תמונה נחתכת — בחרו "לרוחב".',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    fields: [
      ...
      {
        key: 'more_projects',
        label: 'פרויקטים נוספים (בתחתית עמוד הפרויקט)',
        type: 'related_projects',
        hint: 'סמנו אילו פרויקטים אמיתיים יוצגו במקטע "פרויקטים נוספים" של הפרויקט הזה. ריק = שאר הפרויקטים אוטומטית.',
      },
...
// שלבי האשף ליצירת/עריכת פרויקט — כל שלב מקבץ מקטעים מ-projectSchema לפי שמם.
// '__gallery__' = מקטע המדיה (גלריה). שלב עם review:true = סקירה + תצוגה מקדימה.
export const projectSteps = [
  {
    label: 'פרטים',
    sections: ['פרטים בסיסיים', 'נתוני הפרויקט', 'מאפיינים', 'הסביבה'],
  },
  {
    label: 'תמונות',
    sections: ['__gallery__', 'תמונת "על הפרויקט"', 'פריסת התמונה הראשית', 'כיוון התמונה בעמוד "כל הפרויקטים"', 'גלריה לפי קטגוריות', 'תוכניות דירות'],
  },
  {
    label: 'מדיה ומפה',
    sections: ['סרטון', 'סרטונים', 'מיקום על המפה'],
  },
  {
    label: 'יזמים ופרסום',
    sections: ['יזמי הפרויקט', 'מקטעים בעמוד הפרויקט', 'עמודים ופרסום', 'SEO'],
  },
  {
    label: 'סקירה ותצוגה',
    review: true,
